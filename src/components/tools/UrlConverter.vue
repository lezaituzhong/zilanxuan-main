...
<template>
  <div class="h-full flex flex-col gap-4 text-[var(--text-primary)]">
    <div class="flex gap-2 flex-wrap">
      <el-button type="primary" @click="encode" :icon="Operation">URL 编码</el-button>
      <el-button type="success" @click="decode" :icon="Operation">URL 解码</el-button>
    ...
    <div class="flex flex-col gap-4 flex-1 min-h-[400px]">
      <div class="flex flex-col gap-2">
        <span class="text-sm text-[var(--text-tertiary)]">输入</span>
        <el-input
          v-model="input"
          type="textarea"
          :rows="8"
      ...
      <div class="flex flex-col gap-2">
        <span class="text-sm text-[var(--text-tertiary)]">结果</span>
        <el-input
          v-model="output"
          type="textarea"
          :rows="8"
